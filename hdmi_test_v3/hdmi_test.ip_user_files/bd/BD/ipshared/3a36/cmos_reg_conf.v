...
always @(posedge clk)begin
    if(rst == 1'b1)begin
        ...
        case(wr_index_reg)//REG CONFIG TAB
            ...
            9'd203: conf_data <= {DEV_ADDR,24'h303521}; 
            9'd204: conf_data <= {DEV_ADDR,24'h303669}; 
            ...
            9'd218: conf_data <= {DEV_ADDR,24'h380805};
            9'd219: conf_data <= {DEV_ADDR,24'h380900};
            9'd220: conf_data <= {DEV_ADDR,24'h380a02};
            9'd221: conf_data <= {DEV_ADDR,24'h380bd0};
            9'd222: conf_data <= {DEV_ADDR,24'h380c07};
            9'd223: conf_data <= {DEV_ADDR,24'h380d64};
            9'd224: conf_data <= {DEV_ADDR,24'h380e02};
            9'd225: conf_data <= {DEV_ADDR,24'h380fe4};
