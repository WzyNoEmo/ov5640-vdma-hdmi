...
proc create_root_design { parentCell } {
  ...
  # Create instance: breath_led_1, and set properties
  set breath_led_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:breath_led:1.0 breath_led_1 ]
  ...
  connect_bd_net -net OV5640_0_clk_ce [get_bd_pins OV5640_0/clk_ce] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net OV5640_0_cmos_xclk_o [get_bd_ports cmos_xclk] [get_bd_pins OV5640_0/cmos_xclk_o]
  connect_bd_net -net OV5640_0_hs_o [get_bd_pins OV5640_0/hs_o] [get_bd_pins v_vid_in_axi4s_0/vid_active_video] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net OV5640_0_rgb_o [get_bd_pins OV5640_0/rgb_o] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net OV5640_0_vs_o [get_bd_pins OV5640_0/vs_o] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net breath_led_1_led [get_bd_ports led_0] [get_bd_pins breath_led_1/led]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins breath_led_1/clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins rgb2dvi_0/SerialClk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins OV5640_0/rst_n_i] [get_bd_pins breath_led_1/rst_n] [get_bd_pins clk_wiz_0/locked] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net cmos_data_i_0_1 [get_bd_ports cmos_data] [get_bd_pins OV5640_0/cmos_data_i]
  connect_bd_net -net cmos_href_i_0_1 [get_bd_ports cmos_href] [get_bd_pins OV5640_0/cmos_href_i]
  connect_bd_net -net cmos_pclk_i_0_1 [get_bd_ports cmos_pclk] [get_bd_pins OV5640_0/cmos_pclk_i] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net cmos_vsync_i_0_1 [get_bd_ports cmos_vsync] [get_bd_pins OV5640_0/cmos_vsync_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins OV5640_0/cmos_clk_i] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
