...
HD_PWD='C:/Users/WzyNoEmo/Desktop/hdmi_test/hdmi_test.runs/BD_v_tc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_v_tc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_v_tc_0_0.tcl
