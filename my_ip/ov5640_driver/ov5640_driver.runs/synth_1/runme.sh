...
HD_PWD='C:/Users/WzyNoEmo/Desktop/my_ip/ov5640_driver/ov5640_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ov5640_driver.tcl
